...
// Excuses from here: https://gist.githubusercontent.com/fortytw2/78f5f9ef915cb43a3be4/raw/286da386ad35785b2ed9f158e665c8129536e0ce/excuses.txt
const excuse = [
...
module.exports = class a0Command extends Command {
	...
	run(message) {
		let emb_lazy = new Discord.MessageEmbed() //embed
		.setTitle(`${message.member.user.tag} Excuse Today is:`)
		.setDescription(excuse[Math.floor(Math.random() * excuse.length)])
		.setColor('#0099ff')
		.setFooter(`Excuses from fortytw2's Gist!`);
		message.delete()
		message.channel.send(emb_lazy);
}};
